#ifndef AUTO_AIM__YOLO_0526_ORT_HPP
#define AUTO_AIM__YOLO_0526_ORT_HPP
...
{
public:
  YOLO_0526_ORT(const std::string & config_path, bool debug);
...
#endif  // AUTO_AIM__YOLO_0526_ORT_HPP
